...
- **Branch naming:** feature branches use `feat/` prefix (e.g., `feat/devin-activity-monitor`), not `fredotran/`. Use `git branch -m feat/<name>` when creating new feature branches.
